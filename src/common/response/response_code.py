...
class CustomResponseCode(CustomCodeBase):
    ...
    HTTP_202 = (202, 'Request accepted, processing not complete')
    HTTP_204 = (204, 'Request successful, no content returned')
    ...
    HTTP_425 = (425, 'Request could not be processed due to server limitations')
    HTTP_429 = (429, 'Too many requests, server rate limit reached')
    ...
    # Plugin responses
    PLUGIN_INSTALL_SUCCESS = (200, 'Plugin installed successfully. Please follow the plugin instructions (README.md) to configure and restart the service')
    PLUGIN_UNINSTALL_SUCCESS = (200, 'Plugin uninstalled successfully. Please remove relevant configurations according to the plugin instructions (README.md) and restart the service')
...
class CustomResponse:
    """
    Provides open response status codes, not just enums. 
    Useful if you want to define custom response messages.
    """
